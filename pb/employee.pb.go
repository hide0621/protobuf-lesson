...
type Employee struct {
	...
	PhoneNumber []string                    `protobuf:"bytes,5,rep,name=phone_number,json=phoneNumber,proto3" json:"phone_number,omitempty"` //repeatedをつけたフィールドは配列のように複数の要素を持つことが出来る
	...
	Birthday *Data              `protobuf:"bytes,9,opt,name=birthday,proto3" json:"birthday,omitempty"`
}
...
func (x *Employee) GetBirthday() *Data {
	if x != nil {
		return x.Birthday
	}
	return nil
...
var file_proto_employee_proto_rawDesc = []byte{
	...
	0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x08, 0x62, 0x69, 0x72, 0x74,
...
var file_proto_employee_proto_depIdxs = []int32{
	...
	6, // 3: employee.Employee.birthday:type_name -> data.Data
